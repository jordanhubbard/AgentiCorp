...
// ConfigSnapshot is the full, import/exportable configuration for Arbiter.
...
func (a *Arbiter) GetConfigSnapshot(ctx context.Context) (*ConfigSnapshot, error) {
...
func (a *Arbiter) ExportConfigSnapshotYAML(ctx context.Context) ([]byte, error) {
...
func (a *Arbiter) ImportConfigSnapshotYAML(ctx context.Context, data []byte) (*ConfigSnapshot, error) {
...
func (a *Arbiter) ApplyConfigSnapshot(ctx context.Context, snap *ConfigSnapshot) error {
	if snap == nil {
...
func (a *Arbiter) ReloadFromDatabase(ctx context.Context) error {
	if a.database == nil {
		return nil
	}
